"""
Inference script for LLM-as-judge evaluation with process supervision labels.
"""
import argparse
import ast
import datetime
            ...
            for i in range(max_retries):
                try:
                    if use_responses_api:
                        # use responses api
                        # handle dict fields in sampling_config
                        ...
                        out1 = litellm.completion(
                            ...
                            **sampling_config,
                            thinking=sampling_config.get("thinking", None),
